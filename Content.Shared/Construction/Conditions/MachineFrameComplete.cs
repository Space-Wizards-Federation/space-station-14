...
namespace Content.Shared.Construction.Conditions
{
    ...
    public sealed partial class MachineFrameComplete : IGraphCondition
    {
        ...
        public bool Condition(EntityUid uid, IEntityManager entityManager)
        {
            ...
            return entityManager.EntitySysManager.GetEntitySystem<SharedMachineFrameSystem>().IsComplete(machineFrame);
        }
        ...
        public bool DoExamine(ExaminedEvent args)
        {
            ...
            var constructionSys = entityManager.System<SharedConstructionSystem>();
            ...
            if (entityManager.EntitySysManager.GetEntitySystem<SharedMachineFrameSystem>().IsComplete(machineFrame))
                return false;
